...
public class OTPGeneratePage extends javax.swing.JFrame
{
    public OTPGeneratePage() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        NewPasswordPage page = new NewPasswordPage();
        page.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new OTPGeneratePage().setVisible(true);
        });
    }
